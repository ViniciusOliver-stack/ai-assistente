...
import { DemoDialog } from "./ui/demo-dialog"
import { AnimatedGradientText } from "./animations/animated-gradient-text"

export function HeroSection() {
  return (
    <section className="flex flex-col w-[80%] mx-auto min-h-screen mt-10">
      <header className="flex items-center justify-between py-4">
        <Image src="/logo-white.svg" alt="Rubnik" width={150} height={120} />
      ...
      <div className="grid lg:grid-cols-2 flex-1 relative">
        <div className="gap-6 flex flex-1 justify-center flex-col z-10">
          <AnimatedGradientText>
            🤖 Crie agentes com poucos cliques!
          </AnimatedGradientText>
          <h1 className="text-4xl md:text-5xl font-semibold max-w-[22ch] animate-in slide-in-from-bottom-8 fade-in duration-500">
            ...
            e envolvente em seus atendimentos.
          </h1>
          <p className="pb-2 max-w-[54ch] text-lg font-light 2xl:max-w-[64ch] text-foreground/80 animate-in slide-in-from-bottom-8 fade-in duration-700">
            A inteligência artificial da Rubnik personaliza interações com os
            clientes, otimiza tempo e qualidade, elevando a experiência do
            cliente para um novo nível de eficiência e engajamento.
          </p>
